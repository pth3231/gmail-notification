"""
Email Processor - Extraction, Cleaning, and Combination
...
def extract_emails_data(
    ...
    for msg_index, msg in enumerate(messages, 1):
        ...
        sender = _extract_header_value(headers, 'From', 'Unknown Sender')
        subject = _extract_header_value(headers, 'Subject', 'No Subject')
